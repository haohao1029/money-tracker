...
mysqli_stmt_bind_param($sqlIncomeBar, 'ii', $id, $year);
...
mysqli_stmt_bind_param($sqlExpenseBar, 'ii', $id, $year);
...
mysqli_stmt_bind_param($sqlIncomePie, 'ii', $id, $year);
...
mysqli_stmt_bind_param($sqlExpensePie, 'ii', $id, $year);
