...
if ($action == 0) { // go to current month
    ...
    $targetDate = strtotime($action . 'day', $dateShowing);
} else {
    // error
}
...
mysqli_stmt_bind_param($sqlIncomeBar, 'iiii', $family_id, $year, $month, $day);
...
mysqli_stmt_bind_param($sqlExpenseBar, 'iiii', $family_id, $year, $month, $day);
...
mysqli_stmt_bind_param($sqlIncomePie, 'iiii', $family_id, $year, $month, $day);
...
mysqli_stmt_bind_param($sqlExpensePie, 'iiii', $family_id, $year, $month, $day);
