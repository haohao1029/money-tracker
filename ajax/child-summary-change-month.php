...
include '../conn.php';
$action = $_GET['action_val'];
$dateShowing = $_GET['date_showing'];
$id = $_GET['id'];
...
mysqli_stmt_bind_param($sqlIncomeBar, 'iii', $id, $year, $month);
...
mysqli_stmt_bind_param($sqlExpenseBar, 'iii', $id, $year, $month);
...
mysqli_stmt_bind_param($sqlIncomePie, 'iii', $id, $year, $month);
...
mysqli_stmt_bind_param($sqlExpensePie, 'iii', $id, $year, $month);
