...
mysqli_stmt_bind_param($sqlIncomeBar, 'iiii', $user_id, $year,$month, $day);
...
mysqli_stmt_bind_param($sqlExpenseBar, 'iiii', $user_id, $year,$month, $day);
...
mysqli_stmt_bind_param($sqlIncomePie, 'iiii', $user_id, $year,$month, $day);
...
mysqli_stmt_bind_param($sqlExpensePie, 'iiii', $user_id, $year,$month, $day);
