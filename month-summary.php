...
<head>
    ...
    <script src="js/month-summary.js"></script>
</head>
...
<body>
    ...
    WHERE 
        ...
        AND MONTH(t.trans_date) = ?"
                    ...
                    mysqli_stmt_bind_param($sqlIncomeBar, 'iii', $user_id, $year, $month);
    ...
    WHERE 
        ...
        AND MONTH(t.trans_date) = ?"
                    ...
                    mysqli_stmt_bind_param($sqlExpenseBar, 'iii', $user_id, $year, $month);
                    ...
                    mysqli_stmt_bind_param($sqlIncomePie, 'iii', $user_id, $year, $month);
                    ...
                    mysqli_stmt_bind_param($sqlExpensePie, 'iii', $user_id, $year, $month);
