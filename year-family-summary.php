...
<head>
    ...
    <script src="js/year-family-summary.js"></script>
</head>
...
<body>
    ...
    WHERE 
        ...
        AND YEAR(t.trans_date) = ?"
                    ...
                    mysqli_stmt_bind_param($sqlIncomeBar, 'ii', $family_id, $year);
    ...
    WHERE 
        ...
        AND YEAR(t.trans_date) = ?"
                    ...
                    mysqli_stmt_bind_param($sqlExpenseBar, 'ii', $family_id, $year);
                    ...
                    mysqli_stmt_bind_param($sqlIncomePie, 'ii', $family_id, $year);
                    ...
                    mysqli_stmt_bind_param($sqlExpensePie, 'ii', $family_id, $year);
