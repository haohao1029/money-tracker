...
<head>
    ...
    <script src="js/year-child-summary.js"></script>
</head>
...
<body>
    ...
    WHERE 
        ...
        AND YEAR(t.trans_date) = ?"
                    ...
                    mysqli_stmt_bind_param($sqlIncomeBar, 'ii', $uid, $year);
    ...
    WHERE 
        ...
        AND YEAR(t.trans_date) = ?"
                    ...
                    mysqli_stmt_bind_param($sqlExpenseBar, 'ii', $uid, $year);
                    ...
                    mysqli_stmt_bind_param($sqlIncomePie, 'ii', $uid, $year);
                    ...
                    mysqli_stmt_bind_param($sqlExpensePie, 'ii', $uid, $year);
