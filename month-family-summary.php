...
<head>
    ...
    <script src="js/month-family-summary.js"></script>
</head>
...
<body>
    ...
    WHERE 
        ...
        AND MONTH(t.trans_date) = ?"
                    ...
                    mysqli_stmt_bind_param($sqlIncomeBar, 'iii', $family_id, $year, $month);
    ...
    WHERE 
        ...
        AND MONTH(t.trans_date) = ?"
                    ...
                    mysqli_stmt_bind_param($sqlExpenseBar, 'iii', $family_id, $year, $month);
                    ...
                    mysqli_stmt_bind_param($sqlIncomePie, 'iii', $family_id, $year, $month);
                    ...
                    mysqli_stmt_bind_param($sqlExpensePie, 'iii', $family_id, $year, $month);
