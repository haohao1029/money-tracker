...
mysqli_stmt_bind_param($sqlIncomeBar, 'iii', $uid, $year, $month);
...
mysqli_stmt_bind_param($sqlExpenseBar, 'iii', $uid, $year, $month);
...
mysqli_stmt_bind_param($sqlIncomePie, 'iii', $uid, $year, $month);
...
mysqli_stmt_bind_param($sqlExpensePie, 'iii', $uid, $year, $month);
...
<head>
    ...
    <script src="js/month-child-summary.js"></script>
