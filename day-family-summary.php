...
<head>
    ...
    <script src="js/day-family-summary.js"></script>
</head>
        ...
        <div class="row center control">
            <div class="trans-total col-11 col-sm-10 col-md-9 col-lg-8 col-xl-7 animated bounceInUp">
                ...
                <div class="col--body">
                    ...
                    mysqli_stmt_bind_param($sqlIncomeBar, 'iiii', $year, $month, $day, $family_id);
                    ...
                    mysqli_stmt_bind_param($sqlExpenseBar, 'iiii', $year, $month, $day, $family_id);
                    ...
                    mysqli_stmt_bind_param($sqlIncomePie, 'iiii', $year, $month, $day, $family_id);
                    ...
                    mysqli_stmt_bind_param($sqlExpensePie,  'iiii', $year, $month, $day, $family_id);
